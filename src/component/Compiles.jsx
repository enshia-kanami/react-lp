        ...
        <div className="text-base bg-slate-50">
            ...
            <contact className="bg-slate-200">
                <div className="rounded-lg shadow-xl bg-white m-8 ... p-3">
                    <h3 className="text-center m-8 text-2xl">お問合せ</h3>
                        <form>
                            <div className="mb-2 text-center">
                                <label className="text-left w-3/12 inline-block">お名前:</label>
                                <input className="bg-gray-100" type="text" placeholder="佐藤 太郎"></input>
                            </div>
                            <div className="mb-2 text-center">
                                <label className="text-left w-3/12 inline-block">メールアドレス:</label>
                                <input className="bg-gray-100" type="email" placeholder="hoge@hoge.com"></input>
                            </div>
                            <div className="mb-2 text-center">
                                <label className="items-start text-left w-3/12 inline-block">お問合せ内容:</label>
                                <textarea className="bg-gray-100" placeholder="お問い合わせ"></textarea>
                            </div>
